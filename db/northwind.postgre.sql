...
CREATE TABLE customerdemographics (
    CustomerTypeID character(10) PRIMARY KEY,
...
ALTER TABLE public.employees ADD CONSTRAINT employees_ReportsTo_fkey FOREIGN KEY (ReportsTo) REFERENCES employees (EmployeeID);
...
CREATE TABLE orders (
    ...
    CustomerID character(5) REFERENCES customers (CustomerID),
    EmployeeID bigint REFERENCES employees (EmployeeID),
    OrderDate date,
    RequiredDate date,
    ShippedDate date,
    ShipVia bigint REFERENCES shippers (ShipperID),
...
CREATE TABLE customercustomerdemo (
    CustomerID character(5) NOT NULL REFERENCES customers (CustomerID),
    CustomerTypeID character(10) NOT NULL REFERENCES customerdemographics (CustomerTypeID),
...
CREATE TABLE employeeterritories (
    ...
    TerritoryID character varying(20) NOT NULL REFERENCES territories (TerritoryID),
...
--
-- Name: public; Type: ACL; Schema: -; Owner: bazy
--

REVOKE ALL ON SCHEMA public FROM PUBLIC;
REVOKE ALL ON SCHEMA public FROM bazy;
